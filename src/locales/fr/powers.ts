export default {
  ...
  "2P009": {
    position: 10,
    name: "Silence de la Tombe",
    description: "Vos pas et [Voie des ombres] font nettement moins de bruit.",
  },
  "2P010": {
    position: 7,
  ...
  "34P003": {
    ...
    name: "Pierre Volante",
    description:
      "[Carnage] devient un coup sauté si vous sautez pendant son temps d'incantation.",
  },
  "34P009": {
    position: 11,
  ...
  "35P009": {
    position: 9,
    name: "Double Suzu",
    description: "[Suzu de protection] obtient une charge supplémentaire",
  },
  "35P010": {
    position: 10,
  ...
  "22P003": {
    position: 3,
    name: "Prescription Parfaite",
    description:
      "Votre [Fusil biotique] peut désormais faire des coups critiques, que sa cible soit alliée ou ennemie.",
  },
  "22P004": {
    position: 5,
    name: "Doux Rêve",
  ...
  "29P007": {
    position: 6,
    name: "Canon Double",
    description: "[Canon scié] obtient une charge supplémentaire.",
  },
  "29P008": {
    position: 8,
  ...
  "41P001": {
    ...
    name: "MédiMaster",
    description:
      "Votre [Médiblaster] peut désormais faire des coups critiques, que sa cible soit alliée ou ennemie.",
  },
  "41P002": {
    position: 2,
    name: "Piqûre",
  ...
  "20P005": {
    position: 6,
    name: "Envol de boule de neige",
    description:
      "Losque vous sautez en étant déjà dans les airs, vous créez sous vous un grand pilier de glace à l'aide de [Mur de glace]. Temps de rechargement: 12 s.",
  },
  "20P006": {
    position: 5,
    name: "Deux fois plus de Glace",
    description:
      "Lorsque vous utilisez [Cryostase], le prochain temps de recharge de [Mur de glace] est réinitialisé.",
  },
  "20P007": {
    position: 7,
    name: "Iceberg",
    description:
      "[Mur de glace] fait apparaître un petit [Blizzard] qui ralentit les adversaires.",
  },
  "20P008": {
    position: 9,
    name: "Cyclone Glacial",
    description:
      "[Cryostase] fait apparaître un petit [Blizzard] qui ralentit les adversaires.",
  },
  "20P009": {
    position: 8,
    name: "Boule Froide",
  ...
  "43P002": {
    ...
    description:
      "Lorsqu'un carreau de [Dans le mille] colle à la cible, vous envoyez automatiquement dans sa direction <e>3</e> carreaux d'arbalète supplémentaires qui infligent des dégâts <e>réduits de 66 %</e>.",
  },
  "43P003": {
    position: 4,
    name: "Tir sismique",
    description:
      "Le rayon d'explosion de [Dans le mille] augmente de <e>33 %</e>. Cet effet est doublé si le carreau est collé à la cible.",
  },
  "43P004": {
    position: 2,
    name: "Enfiler l'aiguille",
    description:
      "Les carreaux de [Dans le mille] transpercent les adversaires. Les explosions supplémentaires infligent des dégâts réduits de <e>66 %</e>.",
  },
  "43P005": {
    position: 7,
    name: "Poches Profondes",
    description:
      "Lorsque vous utilisez une capacité, vous récupérez <e>25 %</e> de votre maximum de munitions.",
  },
  "43P006": {
    position: 5,
    name: "Herboriste",
    description:
      "Pendant <e>2 s</e> après l'utilisation de [Ruée rapide], les tirs réussis de votre [arbalète Rafale] vous rendent <e>4 %</e> de vos points de vie maximum.",
  },
  "43P007": {
    position: 6,
    name: "Performance Maximale",
    description:
      "Tant que vous attaquez avec votre [arbalète Rafale], votre vitesse de chute est réduite de <e>80 %</e>.",
  },
  "43P008": {
    position: 8,
    name: "Renouveau",
    description:
      "Les tirs d'[arbalète Rafale] qui touchent des cibles piégées par [Dans le mille] ou [Tir de bolas] réduisent le temps de recharge de vos capacités de <e>5 %</e> et vous rendent <e>1</e> munition.",
  },
  "43P009": {
    position: 9,
    name: "Volée à deux",
    description:
      "Tous les cinq tirs à l'[arbalète Rafale], vous projetez <e>2</e> carreaux supplémentaires qui infligent des dégâts <e>réduis de 33 %</e>.",
  },
  "43P010": {
    position: 11,
    name: "Lille Fælde",
    description:
      "Après [Courant ascendant], votre prochain [Dans le mille] depuis les airs lance un mini [Tir de Bolas] qui n'attire pas l'adversaire et inflige des dégâts <e>réduits de 40 %</e>.",
  },
  "43P011": {
    position: 10,
    name: "Cuisson parfaite",
    description:
      "La zone de dégâts de [Tir de bolas] persiste pendant <e>3 s</e> et inflige des dégâts augmentés de <e>30 %</e>. Les éliminations à l'aide de [Tir de bolas] comptent pour [Chasseuse de primes].",
  },
  "43P012": {
    position: 12,
    name: "Bourrasque Puissante",
    description:
      "[Courant ascendant] projette une rafale dans la direction de votre viseur, ce qui repousse les adversaires et leur inflige <ap>40</ap> points de dégâts.",
  },
  "10P001": {
    position: 1,
