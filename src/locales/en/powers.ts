export default {
  ...
  "13P009": {
    name: "Lifelift",
    description:
      "+50% [Particle Barrier] size. Increase [Particle Barrier] Health by 50% of Bonus Max Life.",
  },
  "13P010": {
    name: "Major Flex",
    description:
  ...
  "16P009": {
    ...
    name: "Crowd Pleaser",
    description:
      "After using [Soundwave], heal all allies affected by [Crossfade] for 150% of [Crossfade] healing.",
  },
  "16P010": {
    position: 10,
    name: "Let's Bounce",
