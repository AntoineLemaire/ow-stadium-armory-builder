...
const privacyTexts = {
    ...
    sections: [
        ...
        content: (
          <>
            ...
            <p>
              ...
              <a href="mailto:overwatchbuilds@gmail.com">
                overwatchbuilds@gmail.com
              </a>
              .
            </p>
          </>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              When you register or sign in using Firebase Authentication, I
            ...
            <p>
              Please note that your email address is <strong>not stored</strong>{" "}
              by me; it is used only by Firebase Authentication for login
              purposes.
            </p>
          </>
        ),
      },
      {
        ...
        content: (
          <>
            <p>I process your personal data to:</p>
            <ul>
              <li>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              I use <strong>Firebase Authentication</strong>, a service provided
              by Google LLC, as the authentication provider. Firebase
              Authentication acts as a data processor on my behalf.
            </p>
            <p>
              Firebase Authentication processes your data according to Google’s{" "}
              <a
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <p>
              You have the right to delete your account and personal data at any
              time. You can do this easily through the user panel in the
      ...
      },
      {
        ...
        content: (
          <p>
            ...
            session. I do <strong>not</strong> use cookies for authentication or
            tracking purposes.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            I may update this notice from time to time. I encourage you to
  ...
  fr: {
    title: "Avis de confidentialité — Authentification et données utilisateur",
    sections: [
      {
        ...
        content: (
          <>
            <p>
              ...
              Authentication, je collecte et traite les données personnelles
              suivantes :
            </p>
            <ul>
              <li>Nom d'utilisateur</li>
              <li>
                Jetons d'authentification (gérés en toute sécurité par Firebase)
              </li>
              <li>Identifiants utilisateur (par exemple, ID utilisateur)</li>
            </ul>
            <p>
              Veuillez noter que votre adresse e-mail n'est{" "}
              <strong>pas stockée</strong> par mes soins ; elle est uniquement
      ...
      },
      {
        ...
        content: (
          <>
            <p>Je traite vos données personnelles pour :</p>
            <ul>
              <li>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              J'utilise <strong>Firebase Authentication</strong>, un service
              fourni par Google LLC, comme fournisseur d'authentification.
              Firebase Authentication agit en tant que sous-traitant pour mon
              compte.
            </p>
            <p>
            ...
            <p>
              Les données peuvent être stockées et traitées dans des centres de
              données situés dans l'Union européenne ou dans d'autres régions,
              selon l'infrastructure de Firebase.
            </p>
          </>
        ),
      },
        ...
        content: (
          <>
            ...
            <p>
              ...
              personnelles à tout moment. Vous pouvez le faire facilement via le
              panneau utilisateur dans l’application. Si vous avez besoin
      ...
      },
      {
        ...
        content: (
          <p>
            Cette application utilise des technologies de stockage du navigateur
            telles que <strong>localStorage</strong> et{" "}
            <strong>IndexedDB</strong> pour stocker en toute sécurité les jetons
            d'authentification et maintenir votre session de connexion. Je
            <strong>n'utilise pas</strong> de cookies pour l'authentification ou
            le suivi.
          </p>
        ),
      },
      {
        ...
        content: (
          <p>
            Je peux mettre à jour cet avis de temps à autre. Je vous encourage à
