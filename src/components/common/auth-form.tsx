    ...
    >
      ...
      {authMode === "register" && (
        <Typography variant="caption" color="textSecondary">
          ...
          to remind you that you can use the Armory Builder without creating an
          account.
          <br />
          Creating an account allows you to save your builds for easier access,
          vote for builds and other features that requires us to clearly
          identify a user.
          <br />
          ...
          <br />
          Our short (honestly, we wrote it as short as possible) Privacy Policy
          notice explains how we handle your data and what rights you have.
          <br />
        </Typography>
      )}
